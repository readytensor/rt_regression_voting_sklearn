# Voting Regression with Shapley Explanations

## Project Description

This repository is a dockerized implementation of the Voting regressor. It is implemented in flexible way that it can be used with any regression dataset with the use of JSON-formatted data schema file.
...
- **`src/`**: This directory holds the source code for the project. It is further divided into various subdirectories:
  ...
  - **`prediction/`**: Scripts for the Voting Regression classifier model.
